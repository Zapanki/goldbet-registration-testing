...
### BUG-06: На узких мобильных экранах форма обрезается по горизонтали
- **Критичность:** High | **Приоритет:** High
- **Шаги:** Открыть форму регистрации на устройстве с шириной экрана менее 400px.
- **Фактический результат:** Интерфейс не масштабируется. Правый край контейнера уходит за экран, обрезая текст согласия с правилами и часть элементов управления.
- **Ожидаемый результат:** Контейнер должен быть адаптивным и полностью помещаться во viewport.
- **Влияние на бизнес:** Прямая потеря мобильной конверсии из-за физической невозможности взаимодействовать с формой.

![BUG-06: Мобильная верстка](assets/bug06-mobile.jpg)
...
![BUG-05: Ошибка капчи в оффлайне](assets/bug05-offline.jpg)
